...
internal class PrivateThirdPartyEndpointTest : MockContextTestCase() {
    ...
    @Test
    fun updateConnectionParams_invalidPath() =
        runTest {
    ...
    @Test
    fun updateConnectionParams_differentFirstPartyEndpoint() =
        runTest {
            val channel = createEndpointChannel(RecipientAddressType.PRIVATE)
            val thirdPartyEndpoint = channel.thirdPartyEndpoint as PrivateThirdPartyEndpoint
    ...
    @Test
    fun updateConnectionParams_differentThirdPartyEndpoint() =
        runTest {
            val channel = createEndpointChannel(RecipientAddressType.PRIVATE)
            val thirdPartyEndpoint = channel.thirdPartyEndpoint as PrivateThirdPartyEndpoint
    ...
    @Test
    fun updateConnectionParams_valid() =
        runTest {
            val channel = createEndpointChannel(RecipientAddressType.PRIVATE)
            val thirdPartyEndpoint = channel.thirdPartyEndpoint as PrivateThirdPartyEndpoint
